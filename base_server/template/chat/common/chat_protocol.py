...
class ChatProtocol:
    def __init__(self):
        self.on_chat_room_list_req_callback = None
        self.on_chat_room_create_req_callback = None
        self.on_chat_message_send_req_callback = None
        self.on_chat_message_list_req_callback = None
        self.on_chat_summary_req_callback = None
        self.on_chat_analysis_req_callback = None
        self.on_chat_persona_list_req_callback = None
        self.on_chat_room_delete_req_callback = None
